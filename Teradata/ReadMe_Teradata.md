...
<img src="images/Teradata_Row64_Integration.png" width="500">
<br>

Teradata is a a RDBMS which targets predictable performance scaling with with: data volume, breadth, number of users and complexity of queries.  It's well known for using parallelism to manage large scale data.  Teradata integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from Teradatato Row64.  An overview is available here:
...
<br><br><img src="images/Teradata_Cron_Job.png" width="500">
...
To setup Teradata intetgration, install the following pip libraries:
<br>
```
...
<br><br>The Teradata intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBHost, DBUsername, DBPassword</b>
<br>
## Download Teradata Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/row64tools/
<br></b>

The Teradata integration is in the sub-folder:
...
<br>https://stackoverflow.com/questions/35938320/connecting-python-with-teradata-using-teradata-module<br>
