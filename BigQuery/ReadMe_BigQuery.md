...
<img src="images/BigQuery_Row64_Integration.png" width="500">
<br>

BigQuery is Google's interactive query service for web-based cloud storage, it is designed for fast query execution and search features.  BigQuery integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from BigQueryto Row64.  An overview is available here:
...
<br><br><img src="images/BigQuery_Cron_Job.png" width="500">
...
To setup BigQuery intetgration, install the following pip libraries:
<br>
```
...
<br><br>The BigQuery intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBHost, DBUsername, DBPassword</b>
<br>
## Download BigQuery Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/row64tools/
<br></b>

The BigQuery integration is in the sub-folder:
...
<br>https://www.rudderstack.com/guides/how-to-access-and-query-your-bigquery-data-using-python-and-r<br>
