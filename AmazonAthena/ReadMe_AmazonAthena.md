...
<img src="images/AmazonAthena_Row64_Integration.png" width="500">
<br>

Amazon Athena is a interactive queries service for web-based cloud storage, designed for quick access to Amazon S3 using standard SQL.  Amazon Athena integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from Amazon Athenato Row64.  An overview is available here:
...
<br><br><img src="images/AmazonAthena_Cron_Job.png" width="500">
...
To setup Amazon Athena intetgration, install the following pip libraries:
<br>
```
...
<br><br>The Amazon Athena intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBAccKey, DBSecKey, DBRegion, DBSchema, and DBS3Dir</b>
<br>
## Download Amazon Athena Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/row64tools/
<br></b>

The Amazon Athena integration is in the sub-folder:
...
<br>https://medium.com/codex/connecting-to-aws-athena-databases-using-python-4a9194427638<br>
