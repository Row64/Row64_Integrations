# Trino Integration
<img src="images/Trino_Row64_Integration.png" width="500">
<br>

Trino is a fork of the Presto SQL database and is written in Java.  It is designed to be a highly parallel and distributed query engine.  Trino integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from Trinoto Row64.  An overview is available here:
...
<br><br><img src="images/Trino_Cron_Job.png" width="500">
...
To setup Trino intetgration, install the following pip libraries:
<br>
```
...
<br><br>The Trino intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBHost, DBUsername, DBPort, DBSchema, DBCatalog</b>
<br>
## Download Trino Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/row64tools/
<br></b>

The Trino integration is in the sub-folder:
...
<br>https://github.com/trinodb/trino-python-client<br>
