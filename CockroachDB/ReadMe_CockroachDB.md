...
<img src="images/CockroachDB_Row64_Integration.png" width="500">
<br>

CockroachDB is a an open source distributed SQL database built for cloud applications, it is designed to survive hardware failure with minimal latency disruption.  CockroachDB integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from CockroachDBto Row64.  An overview is available here:
...
<br><br><img src="images/CockroachDB_Cron_Job.png" width="500">
...
To setup CockroachDB intetgration, install the following pip libraries:
<br>
```
...
<br><br>The CockroachDB intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBHost, DBUsername, fill python ssl and certs</b>
<br>
## Download CockroachDB Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/row64tools/
<br></b>

The CockroachDB integration is in the sub-folder:
...
<br>https://www.cockroachlabs.com/docs/v21.1/connect-to-the-database-cockroachcloud?filters=python<br>
