...
<img src="images/Firebolt_Row64_Integration.png" width="500">
<br>

Firebolt is a next-generation cloud data warehouse using Postgres compatible SQL.  It is designed for high-performance real time applications.  Firebolt integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from Fireboltto Row64.  An overview is available here:
...
<br><br><img src="images/Firebolt_Cron_Job.png" width="500">
...
To setup Firebolt intetgration, install the following pip libraries:
<br>
```
...
<br><br>The Firebolt intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBEngine, DBUsername, DBPassword</b>
<br>
## Download Firebolt Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/row64tools/
<br></b>

The Firebolt integration is in the sub-folder:
...
<br>https://python-sdk.docs.firebolt.io/en/latest/Connecting_and_queries.html<br>
