...
<img src="images/ApachePinot_Row64_Integration.png" width="500">
<br>

Apache Pinot is a real-time distributed OLAP datastore designed at LinkedIn for ultra low-latency analytics with extremely high throughput.  Apache Pinot integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from Apache Pinotto Row64.  An overview is available here:
...
<br><br><img src="images/ApachePinot_Cron_Job.png" width="500">
...
To setup Apache Pinot intetgration, install the following pip libraries:
<br>
```
...
<br><br>The Apache Pinot intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBHost, DBPort</b>
<br>
## Download Apache Pinot Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/row64tools/
<br></b>

The Apache Pinot integration is in the sub-folder:
...
<br>https://docs.pinot.apache.org/users/clients/python<br>
