...
<img src="images/YugabyteDB_Row64_Integration.png" width="500">
<br>

YugabyteDB is a distributed PostgreSQL database for cloud native applications.  It is designed to create large web services running up to millions requests per second.  YugabyteDB integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from YugabyteDBto Row64.  An overview is available here:
...
<br><br><img src="images/YugabyteDB_Cron_Job.png" width="500">
...
To setup YugabyteDB intetgration, install the following pip libraries:
<br>
```
...
<br><br>The YugabyteDB intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBHost, DBUsername, DBPassword, DBPort</b>
<br>
## Download YugabyteDB Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/row64tools/
<br></b>

The YugabyteDB integration is in the sub-folder:
...
<br>https://docs.yugabyte.com/preview/develop/tutorials/build-apps/python/cloud-ysql-python/<br>
