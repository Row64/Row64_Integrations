# IBM DB2 Integration
<img src="images/IBMDb2_Row64_Integration.png" width="500">
<br>

IBM DB2 started in the 1970s as one of the first relational databases.  It is designed for performance, scalability and reliability for enterprise business.  IBM DB2 integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from IBM DB2to Row64.  An overview is available here:
...
<br><br><img src="images/IBMDb2_Cron_Job.png" width="500">
...
To setup IBM DB2 intetgration, install the following pip libraries:
<br>
```
...
<br><br>The IBM DB2 intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBHost, DBUsername, DBPassword, DBPort</b>
<br>
## Download IBM DB2 Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/row64tools/
<br></b>

The IBM DB2 integration is in the sub-folder:
...
<br>https://stackoverflow.com/questions/6044326/how-to-connect-python-to-db2<br>
