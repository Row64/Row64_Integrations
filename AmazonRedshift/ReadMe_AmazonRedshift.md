...
<img src="images/AmazonRedshift_Row64_Integration.png" width="500">
<br>

Amazon Redshift is a cloud-based data warehouse service designed for large data data sets stored by a column-oriented DBMS principle.  Amazon Redshift integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from Amazon Redshiftto Row64.  An overview is available here:
...
<br><br><img src="images/AmazonRedshift_Cron_Job.png" width="500">
...
To setup Amazon Redshift intetgration, install the following pip libraries:
<br>
```
...
<br><br>The Amazon Redshift intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBHost, DBPort, DBUsername, and DBPassword</b>
<br>
## Download Amazon Redshift Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/row64tools/
<br></b>

The Amazon Redshift integration is in the sub-folder:
...
<br>https://docs.aws.amazon.com/redshift/latest/mgmt/python-connect-integrate-pandas.html<br>
