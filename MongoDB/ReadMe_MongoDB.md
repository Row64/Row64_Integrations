...
MongoDB is a JSON-like, NoSQL, document-oriented database.  It is designed for flexible schema that can handle dynamic changes, new data types, and differing data structures.  MongoDB integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from MongoDBto Row64.  An overview is available here:
...
<br><br><img src="images/MongoDB_Cron_Job.png" width="500">
...
To setup MongoDB intetgration, install the following pip libraries:
<br>
```
...
<br><br>The MongoDB intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBHost, DBUsername, DBPort, DBPwd</b>
<br>
...
The MongoDB integration is in the sub-folder:
<br>https://github.com/Row64/Row64_Integrations/tree/master/MongoDB
<br></b>
...
<br>https://www.mongodb.com/docs/languages/python/pymongo-driver/current/get-started/<br>
