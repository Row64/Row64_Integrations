# Azure MS SQL Integration
<img src="images/AzureMSSQL_Row64_Integration.png" width="500">
<br>

Microsoft Azure SQL Database handles all the database management functions for cloud based Microsoft SQL Servers, it's designed for fast and flexible SQL queries.  Azure MS SQL integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from Azure MS SQLto Row64.  An overview is available here:
...
<br><br><img src="images/AzureMSSQL_Cron_Job.png" width="500">
...
To setup Azure MS SQL intetgration, install the following pip libraries:
<br>
```
...
<br><br>The Azure MS SQL intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBHost, DBUsername, DBPassword.  Also add path to ssl in python</b>
<br>
## Download Azure MS SQL Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/row64tools/
<br></b>

The Azure MS SQL integration is in the sub-folder:
...
<br>https://docs.microsoft.com/en-us/azure/mysql/single-server/connect-python<br>
