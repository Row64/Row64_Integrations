# Exasol Integration
<img src="images/Exasol_Row64_Integration.png" width="500">
<br>

Exasol is an in-memory, column-oriented relational DBMS.  It is designed for large scale data and flexible deployment to cloud or on-prem data warehouses.  Exasol integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from Exasolto Row64.  An overview is available here:
...
<br><br><img src="images/Exasol_Cron_Job.png" width="500">
...
To setup Exasol intetgration, install the following pip libraries:
<br>
```
...
<br><br>The Exasol intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBHost, DBUsername, DBPassword, DBPort</b>
<br>
## Download Exasol Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/row64tools/
<br></b>

The Exasol integration is in the sub-folder:
...
<br>https://docs.exasol.com/db/latest/sql_reference.htm<br>
