# Sqlite Integration
<img src="images/SQLite_Row64_Integration.png" width="500">
<br>

SQLite is an open-source relational database engine known for simple and flexible integration into software projects and applications.  It's well known for integration into web browsers and embedded systems.  Sqlite integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from Sqliteto Row64.  An overview is available here:
...
<br><br><img src="images/SQLite_Cron_Job.png" width="500">
...
To setup Sqlite intetgration, install the following pip libraries:
<br>
```
...
<br><br>The Sqlite intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b></b>
<br>
...
The Sqlite integration is in the sub-folder:
...
<br>https://datacarpentry.github.io/python-ecology-lesson/instructor/09-working-with-sql.html<br>
