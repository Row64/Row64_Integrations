...
<img src="images/SAPHana_Row64_Integration.png" width="500">
<br>

SAP S/4HANA is an enterprise database designed to be the core of a digital platform that tracks all the resource-based tasks of a company.  SAP S/4HANA integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from SAP S/4HANAto Row64.  An overview is available here:
...
<br><br><img src="images/SAPHana_Cron_Job.png" width="500">
...
To setup SAP S/4HANA intetgration, install the following pip libraries:
<br>
```
...
<br><br>The SAP S/4HANA intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBHost, DBUsername, DBPassword, DBPort</b>
<br>
## Download SAP S/4HANA Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/row64tools/
<br></b>

The SAP S/4HANA integration is in the sub-folder:
...
<br>https://developers.sap.com/tutorials/hana-clients-python.html<br>
