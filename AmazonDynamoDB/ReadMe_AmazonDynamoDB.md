...
The basic connection process is to use row64tools to push updates from Amazon DynamoDBto Row64.  An overview is available here:
...
<br><br><img src="images/AmazonDynamoDB_Cron_Job.png" width="500">
...
To setup Amazon DynamoDB intetgration, install the following pip libraries:
<br>
```
...
<br><br>The Amazon DynamoDB intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b></b>
<br>
## Download Amazon DynamoDB Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/Row64_Integrations
<br></b>

The Amazon DynamoDB integration is in the sub-folder:
<br>https://github.com/Row64/Row64_Integrations/tree/master/AmazonDynamoDB
<br></b>
