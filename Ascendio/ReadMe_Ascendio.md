# Ascend.io Integration
<img src="images/Ascendio_Row64_Integration.png" width="500">
<br>

Ascend.io is an intelligent data automation and pipeline platform that simplifies complex data engineering tasks.  Ascend.io integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from Ascend.ioto Row64.  An overview is available here:
...
<br><br><img src="images/Ascendio_Cron_Job.png" width="500">
...
To setup Ascend.io intetgration, install the following pip libraries:
<br>
```
...
<br><br>The Ascend.io intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBHost, DBUsername, DBPassword, DBPort</b>
<br>
## Download Ascend.io Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/row64tools/
<br></b>

The Ascend.io integration is in the sub-folder:
...
<br>https://developer.ascend.io/docs/sql-functions<br>
