...
Apache Cassandra is an open source, distributed NoSQL, highly scalable & partitioned database.  It is designed to handle large data volumes across servers.  Apache Cassandra integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from Apache Cassandrato Row64.  An overview is available here:
...
<br><br><img src="images/ApacheCassandra_Cron_Job.png" width="500">
...
To setup Apache Cassandra intetgration, install the following pip libraries:
<br>
```
...
<br><br>The Apache Cassandra intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBHost, DBUsername, DBPort</b>
<br>
## Download Apache Cassandra Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/Row64_Integrations
<br></b>

The Apache Cassandra integration is in the sub-folder:
<br>https://github.com/Row64/Row64_Integrations/tree/master/ApacheCassandra
<br></b>
...
<br>https://stackoverflow.com/questions/73639095/how-to-connect-to-cassandra-database-using-python-code<br>
