# Apache Kylin Integration
<img src="images/ApacheKylin_Row64_Integration.png" width="500">
<br>

Apache Kylin is a leading low-cost and sub-second query engine for Hadoop, it is designed for analysing multi-dimensional data (OLAP) from multiple perspectives.  Apache Kylin integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from Apache Kylinto Row64.  An overview is available here:
...
<br><br><img src="images/ApacheKylin_Cron_Job.png" width="500">
...
To setup Apache Kylin intetgration, install the following pip libraries:
<br>
```
...
<br><br>The Apache Kylin intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBHost, DBUsername, DBPassword, DBPort</b>
<br>
## Download Apache Kylin Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/row64tools/
<br></b>

The Apache Kylin integration is in the sub-folder:
...
<br>https://kylin.apache.org/docs/3.1.3/tutorial/sql_reference/<br>
