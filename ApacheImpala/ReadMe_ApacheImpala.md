...
<img src="images/ApacheImpala_Row64_Integration.png" width="500">
<br>
...
The basic connection process is to use row64tools to push updates from Apache Impalato Row64.  An overview is available here:
...
<br><br><img src="images/ApacheImpala_Cron_Job.png" width="500">
...
To setup Apache Impala intetgration, install the following pip libraries:
<br>
```
...
<br><br>The Apache Impala intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBHost. </b>
<br>
...
<br>https://impala.apache.org/docs/build/html/topics/impala_langref.html<br>
