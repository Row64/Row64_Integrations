...
Snowflake is a cloud-native data platform known for lighting speed queries of a columnar-stored data warehouse.  It is well known for low-latency execution of big data workloads.  Snowflake integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from Snowflaketo Row64.  An overview is available here:
...
<br><br><img src="images/Snowflake_Cron_Job.png" width="500">
...
To setup Snowflake intetgration, install the following pip libraries:
<br>
```
...
<br><br>The Snowflake intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBUser, DBPassword, DBAccount</b>
<br>
## Download Snowflake Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/row64tools/
<br></b>

The Snowflake integration is in the sub-folder:
...
<br>https://docs.snowflake.com/en/sql-reference/constructs<br>
