...
<img src="images/ApacheSolr_Row64_Integration.png" width="500">
<br>

Apache Solr is an open-source, multi-modal, enterprise-search platform, written in Java. It is designed for full-text search, real-time indexing and dynamic clustering.  Apache Solr integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from Apache Solrto Row64.  An overview is available here:
...
<br><br><img src="images/ApacheSolr_Cron_Job.png" width="500">
...
To setup Apache Solr intetgration, install the following pip libraries:
<br>
```
...
<br><br>The Apache Solr intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBHost, DBUsername, DBPassword, DBPort</b>
<br>
## Download Apache Solr Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/row64tools/
<br></b>

The Apache Solr integration is in the sub-folder:
...
<br>https://solr.apache.org/guide/solr/latest/query-guide/sql-query.html<br>
