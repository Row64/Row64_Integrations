# IBM Netezza Integration
<img src="images/IBMNetezza_Row64_Integration.png" width="500">
<br>

IBM Netezza is a data warehouse platform that integrates database, server and storage components.  It is designed for demanding hybrid-cloud environments and advanced analytics.  IBM Netezza integrates easily with Row64 by wiring to Row64 RamDb through Python.
<br>
## Integration Overview
The basic connection process is to use row64tools to push updates from IBM Netezzato Row64.  An overview is available here:
...
<br><br><img src="images/IBMNetezza_Cron_Job.png" width="500">
...
To setup IBM Netezza intetgration, install the following pip libraries:
<br>
```
...
<br><br>The IBM Netezza intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DBHost, DBUsername, DBPassword, DBPort</b>
<br>
## Download IBM Netezza Integration
Row64 Integrations can be downloaded from the github project:
<br>https://github.com/Row64/row64tools/
<br></b>

The IBM Netezza integration is in the sub-folder:
...
<br>https://docs.dominodatalab.com/en/latest/user_guide/5a641d/connect-to-ibm-netezza/#_credential_setup<br>
