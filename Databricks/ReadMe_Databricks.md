...
The basic connection process is to use row64tools to push updates from Databricksto Row64.  An overview is available here:
...
<br><br><img src="images/Databricks_Cron_Job.png" width="500">
...
To setup Databricks intetgration, install the following pip libraries:
<br>
```
...
<br><br>The Databricks intetgration code assumes you create a .env file at the same location as your .py file.And it sets the variables: <b>DATABRICKS_SERVER_HOSTNAME, DATABRICKS_HTTP_PATH, DATABRICKS_TOKEN</b>
<br>
...
<br>https://github.com/Row64/Row64_Integrations/tree/master/Databricks
<br></b>
...
<br>https://docs.databricks.com/aws/en/dev-tools/python-sql-connector<br>
